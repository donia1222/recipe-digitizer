          ...
          {/* Verbessertes Ordner-Sidebar */}
            {showSidebar && (
              <>
                ...
                >
                <div className="bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl rounded-2xl border border-white/20 dark:border-gray-800/20 shadow-xl p-4 sm:p-6 mt-20 lg:mt-0">
