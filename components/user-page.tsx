        ...
        <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="hidden lg:inline-flex items-center px-3 py-1.5 bg-blue-100/60 dark:bg-blue-900/40 backdrop-blur-sm border border-blue-300/60 dark:border-blue-600/60 rounded-full shadow-lg">
                <h1 className="text-base font-semibold text-blue-800 dark:text-blue-200 flex items-center gap-2">
